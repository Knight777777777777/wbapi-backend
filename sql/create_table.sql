...
VALUES (3, 'getName', '获取用户名', 'http://localhost:8123/api/interface/name/user', 'post',
        '{\"Content-Type\":\"application/json\"}', '{\"Content-Type\":\"application/json\"}', 1, 1,
        '2023-07-08 20:00:14', '2023-07-08 20:00:14', 1, '\n{\"name\":\"name\",\"type\":\"string\"}\n',
        'com.czq.apiclientsdk.client.NameApiClient', '{ \"name\": \"czq\"}');
INSERT INTO `interface_info`
VALUES (4, 'getRandomWork', '随机文本', 'http://localhost:8123/api/interface/random/word', 'get', NULL, NULL, 1, 1,
        '2023-07-29 20:33:55', '2023-07-29 20:33:55', 1, '', 'com.czq.apiclientsdk.client.RandomApiClient', NULL);
INSERT INTO `interface_info`
VALUES (5, 'getRandomImageUrl', '随机动漫图片地址', 'http://localhost:8123/api/interface/random/image', 'post', NULL,
        NULL, 1, 1, '2023-07-29 21:51:08', '2023-07-29 21:51:08', 1, NULL,
        'com.czq.apiclientsdk.client.RandomApiClient', NULL);
INSERT INTO `interface_info`
VALUES (6, 'getDayWallpaperUrl', '每日壁纸URL', 'http://localhost:8123/api/interface/day/wallpaper', 'post', NULL, NULL,
        1, 1, '2023-07-29 22:20:10', '2023-07-29 22:20:10', 1, NULL, 'com.czq.apiclientsdk.client.DayApiClient', NULL);
...
(
  ...
  AUTO_INCREMENT = 1677647739169431556
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '用户'
  ROW_FORMAT = Dynamic;

INSERT INTO `user`
VALUES (1, 'xiaochen', '37c639816ab8a12a4e9d8d65d86d04c7', NULL, NULL, 'xiaochen', NULL, NULL, 'admin',
        '2023-07-05 20:04:29', '2023-08-02 16:29:09', 1, '8817b9099f85326da4e633054ff19d93',
        '7132425bf5aac84e7174342df5dae754', NULL, '');
INSERT INTO `user`
VALUES (2, 'chen', '37c639816ab8a12a4e9d8d65d86d04c7', NULL, NULL, 'chen', NULL, NULL, 'user', '2023-07-08 19:56:04',
        '2023-08-02 15:20:00', 1, '163c5da70c75caf832d3109e0753db93', 'f15a031ee34532019827b0283d725e1b', NULL, '');
INSERT INTO `user`
VALUES (1677647739169431556, 'test', '37c639816ab8a12a4e9d8d65d86d04c7', NULL, NULL, 'test', NULL, NULL, 'user',
        '2023-08-02 15:52:45', '2023-08-02 16:33:50', 1, '36b13efe755a0df7250a780cab4d7766',
        'f47a668788954af7e09ad4396b0bbdb7', NULL, '2473221807@qq.com');
...
VALUES (1, 1, 3, 2, 98, 1, 1, '2023-08-02 17:11:46', '2023-08-02 17:11:46', 17);
INSERT INTO `user_interface_info`
VALUES (7, 2, 3, 2, 22, 1, 1, '2023-08-02 17:11:48', '2023-08-02 17:11:48', 6);
INSERT INTO `user_interface_info`
VALUES (8, 1, 4, 1, 189, 1, 1, '2023-08-02 17:10:02', '2023-08-02 17:10:02', 11);
INSERT INTO `user_interface_info`
VALUES (9, 1, 5, 1, 98, 1, 1, '2023-08-02 17:10:34', '2023-08-02 17:10:34', 2);
INSERT INTO `user_interface_info`
VALUES (10, 1, 6, 0, 99, 1, 1, '2023-08-02 17:10:20', '2023-08-02 17:10:20', 1);
INSERT INTO `user_interface_info`
VALUES (11, 2, 4, 0, 99, 1, 1, '2023-08-02 17:10:20', '2023-08-02 17:10:20', 1);
INSERT INTO `user_interface_info`
VALUES (12, 2, 5, 0, 98, 1, 1, '2023-08-02 17:10:22', '2023-08-02 17:10:22', 2);
...
(
    ...
    `availableCalls` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '接口剩余可调用次数',
...
INSERT INTO `interface_charging`
VALUES (1, 3, 0.52, '977', 1, '2023-07-24 14:33:49', '2023-08-02 19:31:39', 1);